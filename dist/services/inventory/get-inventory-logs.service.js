...
async function getInventoryLogsService(params = {}) {
    const { productId, page = 1, limit = 20, startDate, endDate, changeType = "all", } = params;
    ...
    return {
        logs: logs.map((log) => ({
            ...
            change: log.change,
            changeType: log.change > 0 ? "increase" : log.change < 0 ? "decrease" : "neutral",
            note: log.note,
