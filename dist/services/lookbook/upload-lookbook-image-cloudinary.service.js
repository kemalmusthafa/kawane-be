...
exports.uploadLookbookImageCloudinaryService = void 0;
const cloudinary_1 = require("../shared/cloudinary");
const uploadLookbookImageCloudinaryService = async (file) => {
    try {
        // Validasi file
        if (!file) {
        ...
        const uploadResult = await (0, cloudinary_1.cloudinaryUpload)(file, "lookbook");
...
exports.uploadLookbookImageCloudinaryService = uploadLookbookImageCloudinaryService;
