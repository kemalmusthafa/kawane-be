...
const advancedSearchService = async (params = {}) => {
    const { query, categoryId, minPrice, maxPrice, inStock, hasReviews, minRating, sortBy = "createdAt", sortOrder = "desc", page = 1, limit = 10, } = params;
    const filter = {};
    if (query) {
        filter.OR = [
