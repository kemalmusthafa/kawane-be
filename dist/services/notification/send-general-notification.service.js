...
exports.sendGeneralNotificationService = void 0;
const prisma_1 = __importDefault(require("../../prisma"));
const sendGeneralNotificationService = async (data) => {
    try {
        let targetUsers = [];
...
exports.sendGeneralNotificationService = sendGeneralNotificationService;
