...
exports.markNotificationAsReadService = exports.getUnreadNotificationCountService = exports.createPaymentConfirmationNotificationService = exports.createOrderStatusUpdateNotificationService = exports.createWhatsAppOrderNotificationService = exports.createNotificationService = void 0;
...
const createWhatsAppOrderNotificationService = async (orderId) => {
    try {
        // Get order details
        ...
        for (const admin of adminUsers) {
            const notification = await (0, exports.createNotificationService)({
                userId: admin.id,
        ...
        const customerNotification = await (0, exports.createNotificationService)({
            userId: order.userId,
...
exports.createWhatsAppOrderNotificationService = createWhatsAppOrderNotificationService;
const createOrderStatusUpdateNotificationService = async (orderId, newStatus, adminNotes) => {
    try {
        // Get order details
        const order = await prisma_1.default.order.findUnique({
            where: { id: orderId },
        ...
        switch (newStatus) {
            ...
            case "CANCELLED":
                ...
                description = `Your order ${order.whatsappOrderId} has been cancelled. ${adminNotes || ""}`;
                priority = "HIGH";
                break;
            default:
                title = "📋 Order Update";
...
exports.createOrderStatusUpdateNotificationService = createOrderStatusUpdateNotificationService;
const createPaymentConfirmationNotificationService = async (orderId) => {
    try {
        // Get order details
        const order = await prisma_1.default.order.findUnique({
            where: { id: orderId },
...
exports.createPaymentConfirmationNotificationService = createPaymentConfirmationNotificationService;
...
const markNotificationAsReadService = async (userId, notificationId, markAll) => {
    try {
        if (markAll) {
